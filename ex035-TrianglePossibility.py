...
"""
print("-=-" * 20)
print("Analisador de de Trângulo")
print("-=-" * 20)
a = float(input("Primeiro segmento: "))
b = float(input("Segundo segmento: "))
c = float(input("Terceiro segmento: "))
if a < b + c and b < a + c and c < a + b:
    print("Os segmentos {}, {} e {} podem formar um Trângulo!".format(a, b, c))
else:
    print("Os segmentos {}, {} e {} NÃO podem formar um Trângulo!".format(a, b, c))
"""